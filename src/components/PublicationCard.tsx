...
export default function PublicationCard({ publication }: PublicationCardProps) {
  ...
  return (
    <article className="indie-card indie-card-interactive p-6 md:p-7 flex flex-col h-full group">
      ...
      {/* Title */}
      <h3 className="text-xl md:text-2xl font-serif font-bold text-[var(--text-primary)] mb-3 leading-snug group-hover:text-[var(--accent-burdeo)] transition-colors">
      ...
      {/* Excerpt */}
      <p className="text-sm text-[var(--text-secondary)] font-serif leading-relaxed mb-6 flex-grow line-clamp-3">
        {publication.excerpt}
      </p>
